...
import me.frank.spring.boot.wechat.handler.*;
...
public class WechatConfig {
    ...
    @Autowired
    public WechatConfig(LogHandler logHandler, NullHandler nullHandler, KfSessionHandler kfSessionHandler,
                        StoreCheckNotifyHandler storeCheckNotifyHandler, WechatProperties properties,
